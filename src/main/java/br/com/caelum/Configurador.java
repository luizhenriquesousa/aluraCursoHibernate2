...
public class Configurador extends WebMvcConfigurerAdapter {
	...
	/**
	 * Configuração para exceções de erros de Laze
	 */
	@Override
	public void addInterceptors(InterceptorRegistry registry) {
		registry.addWebRequestInterceptor(geEntityManagerInViewInterceptor());
	}

	/**
	 * @Bean vem de algum BD
	 */
	@Bean
	public OpenEntityManagerInViewInterceptor geEntityManagerInViewInterceptor() {
